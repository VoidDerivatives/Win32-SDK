    ...
    {     
        ...
        case WM_COMMAND:
            ...
            switch(LOWORD(wParam))
            {
                    ...
                    case ID_CRITICALSECTION_START:

                        EnableMenuItem(hwndMenu,ID_CRITICALSECTION_START,MF_DISABLED);
                        EnableMenuItem(hwndMenu,ID_CRITICALSECTION_CLEAR,MF_ENABLED);
                    ...
                    case ID_CRITICALSECTION_CLEAR:
                        ...
                        for(i = 0;i<2;i++)
                        {
                            ...
                            EnableMenuItem(hwndMenu,ID_CRITICALSECTION_START,MF_ENABLED);
                            EnableMenuItem(hwndMenu,ID_CRITICALSECTION_CLEAR,MF_DISABLED);
                    ...
                    case ID_HELP_ABOUT:
                            MessageBox(hwnd,TEXT("Use of Critical Section\nMAX = 10000") TEXT("\n\n\t\t\t\t-Aishwarya"),TEXT("ABOUT") , MB_OK);
                            break;
            }
            break;
