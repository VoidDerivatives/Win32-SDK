						...
						LPARAM lParam)
{
	...
	case WM_PAINT:
			...
			hBrush = CreateSolidBrush(RGB(90,32,194));
			...
			SetBkColor(hdc,RGB(255,128,255));
			DrawText(hdc,TEXT("My Star having Blue Color With Winding Mode"),-1,&rect,DT_CENTER | DT_VCENTER | DT_SINGLELINE);
