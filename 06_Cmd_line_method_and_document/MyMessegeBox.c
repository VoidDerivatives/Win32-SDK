...
{	
	MyMessageBox(NULL,MB_OK | MB_ICONERROR,LPCWSTR("Win32"),TEXT("Addition of %d and %d is %d"),10,20,30);

	MyMessageBox(NULL,MB_OK | MB_ICONERROR,LPCWSTR("Win32"),TEXT("%s got %lf percentage int %d standard"),TEXT("Aishwarya"),99.99,12);
