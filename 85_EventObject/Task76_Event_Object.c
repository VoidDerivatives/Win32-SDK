                    ...
                    )
{
    ...
    hEventEven = CreateEvent(NULL,TRUE,TRUE,NULL);
    hEventOdd  = CreateEvent(NULL,TRUE,FALSE,NULL);
    ...
    {     
        ...
        case WM_COMMAND:
            ...
            switch(LOWORD(wParam))
            {
                    ...
                    case ID_EVENTOBJECT_START:

                        EnableMenuItem(hwndMenu,ID_EVENTOBJECT_START,MF_DISABLED);
                        EnableMenuItem(hwndMenu,ID_EVENTOBJECT_CLEAR,MF_ENABLED);
                    ...
                    case ID_EVENTOBJECT_CLEAR:
                        ...
                        for(i = 0;i<2;i++)
                        {
                            ...
                            EnableMenuItem(hwndMenu,ID_EVENTOBJECT_START,MF_ENABLED);
                            EnableMenuItem(hwndMenu,ID_EVENTOBJECT_CLEAR,MF_DISABLED);
                    ...
                    case ID_HELP_ABOUT:
                            MessageBox(hwnd,TEXT("Use of Event Object\nMAX = 10000") TEXT("\n\n\t\t\t\t-Aishwarya"),TEXT("ABOUT") , MB_OK);
                            break;
            }
            break;
