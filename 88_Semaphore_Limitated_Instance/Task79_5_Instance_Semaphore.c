                    ...
                    )
{
    ...
    hSemaphore = CreateSemaphore(NULL,5,5,TEXT("My APP"));

    hMutex = CreateMutex(NULL,FALSE,TEXT("My Application"));
    
    if(WAIT_TIMEOUT == WaitForSingleObject(hSemaphore,0))
    {
    ...
    {     
        ...
        case WM_COMMAND:
            ...
            switch(LOWORD(wParam))
            {
                    ...
                    case ID_SEMAPHORE_START:

                        EnableMenuItem(hwndMenu,ID_SEMAPHORE_START,MF_DISABLED);
                        EnableMenuItem(hwndMenu,ID_SEMAPHORE_CLEAR,MF_ENABLED);
                    ...
                    case ID_SEMAPHORE_CLEAR:
                        ...
                        for(i = 0;i<2;i++)
                        {
                            ...
                            EnableMenuItem(hwndMenu,ID_SEMAPHORE_START,MF_ENABLED);
                            EnableMenuItem(hwndMenu,ID_SEMAPHORE_CLEAR,MF_DISABLED);
                    ...
                    case ID_HELP_ABOUT:
                            MessageBox(hwnd,TEXT("Use of Semaphore For 5 Instance\n") TEXT("\n\n\t\t\t\t-Aishwarya"),TEXT("ABOUT") , MB_OK);
                            break;
            }
            break;
