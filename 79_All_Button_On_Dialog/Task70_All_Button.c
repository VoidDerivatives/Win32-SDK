    ...
    {               
	  case WM_COMMAND:
		switch(LOWORD(wParam))
		{
				...
				case ID_HELP_ABOUT:
						MessageBox(hwnd,TEXT("Use of All Child Window") TEXT("\n\n\t\t\t\t-Aishwarya"),szAppName , MB_OK);
						break;
		}
		break;
...
{
	static HWND hwndCheckBox[3],hStaticBtnText;
	...
	switch(uiMessage)
	{
	  ...
	  case WM_INITDIALOG:
			...
			hStaticBtnText = GetDlgItem(hwnd,IDC_STATIC_TEXT);
				...
				switch(LOWORD(wParam))
				{
					...
					case ID_BTN_SUBMIT:
						...
						case IDC_RADIO_3:
							...
							{
							case BN_CLICKED:
								if(LOWORD(wParam) == IDC_RADIO_1)
									SetWindowText(hStaticBtnText,TEXT("First Radio Button Pushed"));
								else if(LOWORD(wParam) == IDC_RADIO_2)
									SetWindowText(hStaticBtnText,TEXT("Second Radio Button Pushed"));
								else if(LOWORD(wParam) == IDC_RADIO_3)
									SetWindowText(hStaticBtnText,TEXT("Third Radio Button Pushed"));
							}
