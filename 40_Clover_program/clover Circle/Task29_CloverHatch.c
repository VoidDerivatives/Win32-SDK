						...
						LPARAM lParam)
{
	...
	case WM_PAINT:
			...
			if(iColor == 0)
				hPen = CreatePen(PS_SOLID , 1 , RGB(6,1,130));
			else if(iColor == 1)
				hPen = CreatePen(PS_SOLID , 1 , RGB(135,31,74));
			else if(iColor == 2)
				hPen = CreatePen(PS_SOLID , 1 , RGB(24,62,12));
			else if(iColor == 3)
				hPen = CreatePen(PS_SOLID , 1 , RGB(99,19,54));
			else if(iColor == 4)
				hPen = CreatePen(PS_SOLID , 1 , RGB(135,29,21));
			else
				hPen = CreatePen(PS_SOLID , 1 , RGB(118,32,125));
			...
			hBrush = CreateHatchBrush(HS_HORIZONTAL,RGB(150,150,150));
